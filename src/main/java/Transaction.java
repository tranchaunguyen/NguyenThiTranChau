...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        for(TransactionInput i : inputs) {
            i.UTXO = NTTC_Blockchain.UTXOs.get(i.transactionOutputId);
        }

        //Kiểm tra giao dịch hợp lệ
        if(getInputsValue() < NTTC_Blockchain.minimumTransaction) {
            System.out.println("Dau vao giao dich qua be: " + getInputsValue());
            System.out.println("Vui long nhap so luong giao dich lon hon " + NTTC_Blockchain.minimumTransaction);
            return false;
        }
        ...
        for(TransactionOutput o : outputs) {
            NTTC_Blockchain.UTXOs.put(o.id , o);
        }
        ...
        for(TransactionInput i : inputs) {
            ...
            NTTC_Blockchain.UTXOs.remove(i.UTXO.id);
        }
